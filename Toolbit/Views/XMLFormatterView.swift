...
struct XMLFormatterView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            // 页面标题
            PageHeader(
                title: ToolType.xmlFormatter.displayName,
                subtitle: ToolType.xmlFormatter.subtitle,
                icon: ToolType.xmlFormatter.icon,
                color: ToolType.xmlFormatter.color
            )
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack {
                ...
                HStack(spacing: 2) {
                    ...
                    GlassToolButton(icon: "arrow.down.right.and.arrow.up.left", action: compressXML, isDisabled: inputText.isEmpty, help: "压缩 XML")
